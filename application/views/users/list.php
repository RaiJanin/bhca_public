...
<div class="col-lg-12 grid-margin stretch-card">
	<div class="card">
		<div class="card-body">
			...
			<h3 class="students-header" style="text-align:center;">System Users
			...
			<div class="table-responsive">
				<table class="table students-table">
					...
					<tbody>
						...
						<td>" . $row->usertype . "</td>
						<td style='text-align:center'><a href='" . site_url("users/updateuser/" . $row->id) . "' class='btn btn-icons btn-secondary btn-rounded'><i class='mdi mdi-pencil'></i></a>&nbsp;<button type='button' class='btn btn-icons btn-secondary btn-rounded' data-toggle='modal' data-target='#modalDelete" . $row->id . "'><i class='mdi mdi-delete'></i></button></td>
					</tr>";
